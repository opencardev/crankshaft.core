...
NetworkService::NetworkService(QObject* parent)
    : QObject(parent)
    , m_wifiHAL(new WiFiHAL(this))
    , m_bluetoothHAL(new BluetoothHAL(this)) {
    ...
    connect(m_wifiHAL, &WiFiHAL::connectionStateChanged, this, &NetworkService::onWiFiConnectionStateChanged);
    
    // Connect Bluetooth HAL signals
    connect(m_bluetoothHAL, &BluetoothHAL::enabledChanged, this, &NetworkService::onBluetoothEnabledChanged);
    connect(m_bluetoothHAL, &BluetoothHAL::discoveryStateChanged, this, &NetworkService::onBluetoothDiscoveryStateChanged);
    connect(m_bluetoothHAL, &BluetoothHAL::devicesUpdated, this, &NetworkService::onBluetoothDevicesUpdated);
    connect(m_bluetoothHAL, &BluetoothHAL::devicePaired, this, &NetworkService::onBluetoothDevicePaired);
    connect(m_bluetoothHAL, &BluetoothHAL::deviceConnected, this, &NetworkService::onBluetoothDeviceConnected);
    connect(m_bluetoothHAL, &BluetoothHAL::deviceDisconnected, this, &NetworkService::onBluetoothDeviceDisconnected);
    connect(m_bluetoothHAL, &BluetoothHAL::pairingFailed, this, &NetworkService::onBluetoothPairingFailed);
    connect(m_bluetoothHAL, &BluetoothHAL::connectionFailed, this, &NetworkService::onBluetoothConnectionFailed);
