...
class GPSDevice : public FunctionalDevice {
 ...
 public:
  ...
  FunctionalDeviceType getType() const override { return FunctionalDeviceType::GPS; }
  QString getName() const override { return "GPS Receiver"; }
  QString getDescription() const override { return "GPS/GNSS location receiver"; }
