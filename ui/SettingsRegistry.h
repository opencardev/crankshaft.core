...
class SettingsRegistry : public QObject {
  ...
  Q_PROPERTY(QString currentComplexityLevel READ currentComplexityLevel WRITE
                 setCurrentComplexityLevel NOTIFY currentComplexityLevelChanged)
 ...
 public:
  ...
  Q_INVOKABLE void registerCategory(const QString &id, const QString &name, const QString &icon,
                                    int order = 100);

  // Register a settings page within a category
  Q_INVOKABLE void registerPage(const QString &categoryId, const QString &pageId,
                                const QString &name, const QString &icon,
                                const QString &qmlComponent, int complexityLevel = Basic,
                                int order = 100);

  // Register individual settings
  Q_INVOKABLE void registerSetting(const QString &pageId, const QVariantMap &setting);
